...
Navigate to `http://localhost:4200/checklist-template` to access the checklist items template management page.
...
| `src/app/checklistpage/checklist.ts`                 | Page component                         |
